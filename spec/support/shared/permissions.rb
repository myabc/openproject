...
RSpec.shared_examples_for 'a controller action with unrestricted access' do
...
RSpec.shared_examples_for 'a controller action with require_login' do
...
RSpec.shared_examples_for 'a controller action with require_admin' do
...
RSpec.shared_examples_for 'a controller action which needs project permissions' do
